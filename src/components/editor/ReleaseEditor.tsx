                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <div className="pt-4 mt-4 border-t border-zinc-800 space-y-4">
                                                    ...
                                                    <div className="space-y-4 pt-2">
                                                        <label className="text-[10px] font-black uppercase tracking-widest text-zinc-500 block mb-2">After Sign-Up Reward</label>
                                                        <select
                                                        ...
                                                        {selectedSection.data.rewardType && selectedSection.data.rewardType !== 'none' && (
                                                            <div className="space-y-3 p-3 bg-zinc-800/50 border border-zinc-800 rounded-xl">
                                                                ...
                                                                <div>
                                                                    <label className="block text-[9px] font-bold uppercase text-zinc-500 mb-1">Custom Success Message</label>
                                                                    <input
                                                                        type="text"
